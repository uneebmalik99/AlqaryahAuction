...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="form-group">
                        ...
                        <select name="vehicle_type" id="vehicle_type" class="form-control" required>
                            ...
                            <option value="1">Auction Vehicle</option>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="car_buy_price" />
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="form-group">
                        <label class="form-control-label">Starting Bid(AED)</label>
                        <input type="text" class="form-control" name="car_bid" />
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="form-group">
            ...
            function setSelectBox() {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        initDropZone('#mutlidrop', '/dropzone_store/'+$('#auction_id').val())
                        initDropZone('#singledrop', '/single_store/'+$('#auction_id').val())
                    }
                });
            }
    ...
    <script type="text/javascript">
        ...
        function initDropZone(elementId, url){
            // var id = $('#auction_id').val();
            // url += url+id;
            $(elementId).dropzone({
                url: url,
